...
lexicon = {
    'welcome_msg': '<b>Добро пожаловать!</b>\nОтправь боту номер песни или фразу из песни. Также найти песню можно '
                   'по названию на английском или по автору!\nА ещё, выбрав пункт <b>Меню</b> можно вывести список '
                   'песен по некоторым авторам, по содержанию или "❤️ Избранное".',
    'fvrt_empty_msg': 'В папке Избранное пусто. 🤷‍♂️ Чтобы добавить песню в Избранное, нажмите на кнопку с 🤍 под песней.',
    ...
    'not_found_by_num': f'Песня не найдена. 🤷\nНужно отправить боту номер песни '
...
def get_lex_msg(msg_type):
    return lexicon[msg_type]
